...
describe('Testing Algorithim', function(){
    ...
    var mock;
    var expected, expectedTree,expectedPath;
    ...
    describe('Testing basic implementation', function(){
        beforeEach(function() {
    ...
    describe('Testing basic implementation, same values', function(){
        beforeEach(function() {

            mock = {
                pretreatment: [
                    {mut: 'IDH2_p.R140Q',   score: 0.38, mean: 0.2},
                    {mut: 'SETBP1_p.D868N', score: 0.10, mean: 0.22},
                    {mut: 'RUNX1_p.K83*',   score: 0.38, mean: 0.22},
                ...
                C4D1: [
                    {mut: 'IDH2_p.R140Q',   score: 0.22, mean: 0.2},
                    {mut: 'SETBP1_p.D868N', score: 0.20, mean: 0.22},
                    {mut: 'RUNX1_p.K83*',   score: 0.22, mean: 0.22},
                    {mut: 'ASXL1_p.Q760*',  score: 0.49, mean: 0.47},
                    {mut: 'RUNX1_p.R174*',  score: 0.49, mean: 0.49},
                    {mut: 'SRSF2_p.P95H',   score: 0.68, mean: 0.6}
